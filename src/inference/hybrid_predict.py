...
if __name__ == "__main__":
    ...
    print("🤖 Dermatolog AI  Loading... Please wait.")
    ai_asistan = DermatologistAI(cv_model_path=CV_PATH, nlp_model_path=NLP_PATH)
    

    test_image = "Data/train/akiec/ISIC_0026149.jpg"  
    test_text = "Vücudumdaki leke çok kısa sürede yayıldı ve rengi koyulaştı."
